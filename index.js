...
(function plainOldJs(window, annyang) {
  ...
  var Hey = function initHey() {
    ...
    this.html.src = 'http://camo.githubusercontent.com/650245687459cb91cb6047ddb9e110ee56922616/687474703a2f2f692e696d6775722e636f6d2f586d487a366d6a2e706e67';
    ...
    this.commands = {
      ...
      'selector next by id *detect': function selectElementById(detection) {
        Highlighter.erase();
        Highlighter.next('#' + detection);
        Highlighter.underline();
        window.console.info('Select next element by id', detection);
      },
      'selector next by tag *detect': function selectElementByTag(detection) {
        Highlighter.erase();
        Highlighter.next('<' + detection.replace('<', '').replace('>', '') + '>');
        Highlighter.underline();
        window.console.info('Select next element by id', detection);
      },
      'selector next by class *detect': function selectElementByClass(detection) {
        Highlighter.erase();
        Highlighter.next('.' + detection.replace('.', ''));
        Highlighter.underline();
        window.console.info('Select next element by class', detection);
      },
      'selector back by id *detect': function selectElementById(detection) {
        Highlighter.erase();
        Highlighter.next('#' + detection);
        Highlighter.underline();
        window.console.info('Select next element by id', detection);
      },
      'selector back by tag *detect': function selectElementByTag(detection) {
        Highlighter.erase();
        Highlighter.next('<' + detection.replace('<', '').replace('>', '') + '>');
        Highlighter.underline();
        window.console.info('Select next element by id', detection);
      },
      'selector back by class *detect': function selectElementByClass(detection) {
        Highlighter.erase();
        Highlighter.next('.' + detection.replace('.', ''));
        Highlighter.underline();
        window.console.info('Select next element by class', detection);
